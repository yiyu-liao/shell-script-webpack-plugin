...
test('it should new a json file', ({
  ...
  return build(config).then(() => {
    const testJson = require('../.tmp/test.json'); // const testModule = require(join(outputPath, 'tmp.js'));


    truthy(testJson.test); // truthy(testModule)
  });
});
test.after.always('cleanup dist file', () => remove(outputPath));
//# sourceMappingURL=/Users/myself/shell-script-webpack-plugin/node_modules/.cache/ava/797f13006780da74350c19e1c635d616.js.map